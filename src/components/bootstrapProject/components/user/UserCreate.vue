              ...
              <div class="card-body">
                ...
                <div class="row">
                  <div class="col-lg-5">
                    <div class="mt-4">
                      <h5 class="font-size-14 mb-4">
                        <i class="mdi mdi-arrow-right text-primary me-1"></i> Form groups
                      </h5>
                      <form>
                        <div class="mb-3">
                  ...
                  <div class="col-lg-6 ms-lg-auto">
                    <div class="mt-5 mt-lg-4">
                      <h5 class="font-size-14 mb-4">
                        <i class="mdi mdi-arrow-right text-primary me-1"></i> Horizontal form
                      </h5>
                ...
                <div class="row">
                  <div class="col-xl-6 mt-4">
                    <h5 class="font-size-14 mb-4">
                      <i class="mdi mdi-arrow-right text-primary me-1"></i> Floating labels
                    </h5>
                  ...
                  <div class="col-lg-6 mt-4">
                    <h5 class="font-size-14 mb-4">
                      <i class="mdi mdi-arrow-right text-primary me-1"></i> Inline forms layout
                    </h5>
          ...
          <div class="col-lg-12">
            <div class="card">
              <div class="card-body">
                ...
                <p class="card-title-desc">
                  Set heights using classes like <code>.form-control-sm</code> and <code>.form-control-lg</code>.
                </p>
                    ...
                    <div>
                      ...
                      <div class="vstack gap-2">
                        <div class="form-check">
                          ...
                          <label class="form-check-label" for="formCheck1"> Form Checkbox </label>
                        </div>
                        <div class="form-check">
                          <input class="form-check-input" type="checkbox" id="formCheck2" checked />
                          <label class="form-check-label" for="formCheck2"> Form Checkbox checked </label>
                        </div>
                      </div>
                    </div>
                  </div>
                    ...
                    <div class="vstack gap-2">
                      <div>
                        <div class="form-check form-check-right">
                          ...
                          <label class="form-check-label" for="formCheckRight1"> Form Checkbox </label>
                        </div>
                      </div>
                      <div>
                        <div class="form-check form-check-right">
                          <input class="form-check-input" type="checkbox" id="formCheckRight2" checked />
                          <label class="form-check-label" for="formCheckRight2"> Form Checkbox checked </label>
                        </div>
                      </div>
                    </div>
                  </div>
                    ...
                    <div>
                      ...
                      <div class="vstack gap-2">
                        <div class="form-check">
                          ...
                          <label class="form-check-label" for="formRadios1"> Form Radio </label>
                        </div>
                        <div class="form-check">
                          <input class="form-check-input" type="radio" name="formRadios" id="formRadios2" />
                          <label class="form-check-label" for="formRadios2"> Form Radio checked </label>
                        </div>
                      </div>
                    </div>
                  </div>
                      ...
                      <div class="vstack gap-2">
                        <div>
                          <div class="form-check form-check-right">
                            <input
                              ...
                              checked
                            />
                            <label class="form-check-label" for="formRadiosRight1"> Form Radio Right </label>
                          </div>
                        </div>
                        ...
                        <div>
                          <div class="form-check form-check-right">
                            ...
                            <label class="form-check-label" for="formRadiosRight2"> Form Radio Right checked </label>
                          </div>
                        </div>
                      </div>
                    </div>
          ...
          <div class="col-lg-12">
            <div class="card">
              <div class="card-body">
                ...
                <p class="card-title-desc">
                  A switch has the markup of a custom checkbox but uses the <code>.custom-switch</code> class to render
